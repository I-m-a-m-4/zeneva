    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline' https://cdn.jsdelivr.net https://js.paystack.co https://*.paystack.co https://*.paystack.com https://code.iconify.design https://*.iconify.design https://*.google.com https://*.googleapis.com https://*.gstatic.com https://*.vercel-insights.com https://*.vercel-scripts.com https://va.vercel-scripts.com https://*.smartsuppchat.com https://connect.facebook.net https://analytics.tiktok.com https://static.ads-twitter.com https://www.googletagmanager.com; script-src-elem 'self' 'unsafe-inline' https://cdn.jsdelivr.net https://js.paystack.co https://*.paystack.co https://*.paystack.com https://code.iconify.design https://*.iconify.design https://*.google.com https://*.googleapis.com https://*.gstatic.com https://*.vercel-insights.com https://*.vercel-scripts.com https://va.vercel-scripts.com https://*.smartsuppchat.com https://connect.facebook.net https://analytics.tiktok.com https://static.ads-twitter.com https://www.googletagmanager.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://paystack.com https://*.paystack.com https://*.paystack.co https://js.paystack.co; style-src-elem 'self' 'unsafe-inline' https://fonts.googleapis.com https://paystack.com https://*.paystack.com https://*.paystack.co https://js.paystack.co; font-src 'self' data: https://fonts.gstatic.com; img-src 'self' data: https: blob: https://*.firebaseapp.com; media-src 'self' https://*.cloudinary.com https://*.youtube.com https://*.youtube-nocookie.com; connect-src 'self' https://*.paystack.com https://*.paystack.co https://api.paystack.co https://*.googleapis.com https://*.firebaseio.com https://*.firebaseapp.com https://*.google-analytics.com https://*.vercel-insights.com https://*.chowdeck.com https://*.ibb.co https://api.imgbb.com https://*.cloudinary.com https://fonts.googleapis.com https://fonts.gstatic.com https://*.iconify.design https://api.iconify.design https://*.facebook.com https://*.tiktok.com https://*.smartsuppchat.com; frame-src 'self' https://checkout.paystack.com https://js.paystack.co https://*.paystack.com https://*.paystack.co https://*.firebaseapp.com https://www.youtube.com https://*.youtube.com https://www.youtube-nocookie.com https://*.youtube-nocookie.com; frame-ancestors 'none';",
          },
          {
