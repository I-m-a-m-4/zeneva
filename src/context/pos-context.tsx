...
export function POSProvider({ children }: { children: ReactNode }) {
  ...
  const isLoading = isLoadingBusiness || isLoadingProducts || isLoadingReceipts || isLoadingCustomers || isLoadingUsers;
  ...
  const value = useMemo(() => ({
    ...
    currencyCode,
    triggerRefresh,
  }), [business, products, receipts, customers, businessUsers, isLoading, cart, selectedCustomer, subtotal, tax, taxRate, discount, total, paymentMethod, currencySymbol, currencyCode, triggerRefresh]);
