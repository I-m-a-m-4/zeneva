    ...
    return (
        <ThemeProvider forcedTheme="light">
          ...
          "
                    ...
                    <section id="features" className="py-24 px-6 bg-white border-t-4 border-slate-100 relative overflow-hidden">
                        ...
                        <div className="max-w-7xl mx-auto relative z-10">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                                {[
                                    ...
                                    <div key={index} className="group relative p-8 bg-slate-50/50 backdrop-blur-sm border-4 border-dashed border-slate-200 rounded-2xl overflow-hidden transition-all duration-300 isolate cursor-pointer">
                    ...
                    <section ref={zenAIRef} id="how-it-works" className="py-24 px-6 bg-white border-t-4 border-slate-100 relative overflow-hidden bg-noise">
                        <div className="absolute inset-0 z-0 opacity-50" style={{ backgroundImage: 'radial-gradient(circle at 25px 25px, hsl(var(--border)) 1px, transparent 0%)', backgroundSize: '50px 50px' }}></div>
                        <div className="aura-background"></div>
                        <div className="sm:px-6 lg:px-8 max-w-7xl mx-auto relative z-10">
                            <div className="text-center mb-16">
                                ...
                                <div className="bg-slate-50 border-4 border-dashed border-slate-200 rounded-2xl p-6 md:p-8 max-w-4xl mx-auto text-left relative overflow-hidden">
