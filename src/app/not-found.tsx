      ...
      <div className="min-h-screen selection:bg-slate-900 selection:text-white bg-[#F9F8F6] relative overflow-hidden flex flex-col">
        ...
        <main className="flex-grow flex items-center justify-center relative z-10 px-6 pt-32 pb-20">
          <div className="max-w-3xl mx-auto text-center space-y-12">
            ...
            >
              <Button asChild size="lg" className="h-14 px-10 bg-slate-950 text-white rounded-2xl hover:bg-slate-800 transition-all font-bold group">
                <Link href="/">
            ...
            >
              ...
              <div className="flex flex-wrap justify-center gap-x-8 gap-y-4">
                ...
                <Link href="/signup" className="text-sm font-bold text-slate-950 hover:text-slate-500 transition-colors">Get Started</Link>
              </div>
            </motion.div>
          </div>
        </main>
