    ...
    <div className="min-h-screen bg-white text-slate-900 font-body antialiased selection:bg-primary/30 selection:text-slate-900">
      ...
      <header className="relative pt-20 overflow-hidden bg-slate-950">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-28 pb-32 flex flex-col items-center text-center space-y-6">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-white leading-tight max-w-4xl font-bricolage">
          ...
          <div className="hidden lg:block absolute bottom-6 left-12 w-64 p-3 bg-white rounded-xl border border-slate-200 shadow-2xl text-left">
            <div className="flex items-center justify-between border-b pb-2 mb-2">
              ...
              <span className="text-[10px] bg-emerald-50 text-emerald-600 px-1.5 py-0.5 rounded font-bold">Wema Bank</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="p-8 sm:p-10 rounded-3xl bg-[#00A75C] text-white space-y-6 flex flex-col justify-between overflow-hidden shadow-xl min-h-[350px] relative">
            <div className="space-y-3 z-10">
              <h3 className="text-2xl font-bold font-bricolage leading-snug">Keep payments going even when you’re not available.</h3>
          ...
          <div className="p-8 sm:p-10 rounded-3xl bg-[#0D46A0] text-white space-y-6 flex flex-col justify-between overflow-hidden shadow-xl min-h-[350px]">
            <div className="space-y-3">
              <h3 className="text-2xl font-bold font-bricolage leading-snug">Open your business to local & international payments.</h3>
              <p className="text-white/90 text-sm font-light leading-relaxed max-w-md">
      ...
      <section className="py-20 bg-slate-50 border-y border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 font-bricolage">
      ...
      <section className="py-24 bg-white space-y-24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-6 space-y-6 text-center lg:text-left">
            <h3 className="text-3xl sm:text-4xl font-bold text-slate-900 leading-tight font-bricolage">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-20">
          ...
          <div className="bg-[#EAFDF5] rounded-3xl p-8 sm:p-10 border border-emerald-100 flex flex-col md:flex-row items-center justify-between gap-6 shadow-sm">
            <div className="space-y-2">
              <h5 className="text-xl sm:text-2xl font-bold text-slate-950 font-bricolage">
                The Zeneva app will help you manage inventory and sales from your physical store & online sales platforms seamlessly.
              </h5>
            </div>
            <Link href="/" className="flex-shrink-0">
              <Button className="bg-[#00A75C] hover:bg-[#008f4e] text-white rounded-xl font-bold h-12 px-6">
                Learn More
              </Button>
            </Link>
          </div>
      ...
      <section className="py-24 bg-white border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Card 1 */}
            <div className="p-8 rounded-2xl border-2 border-emerald-100 bg-white hover:shadow-md transition-all flex flex-col justify-between h-full shadow-sm">
              ...
              <div className="pt-6 flex items-center gap-2 text-xs text-[#00A75C] hover:text-[#008f4e] font-medium">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-[#00A75C] rounded-3xl p-8 sm:p-12 text-white relative overflow-hidden shadow-xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight font-bricolage">
