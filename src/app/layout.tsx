...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${siteUrl}/zeneva-og-image.png`,
        width: 1200,
        height: 630,
        type: 'image/png',
  ...
  twitter: {
    ...
    images: [`${siteUrl}/zeneva-og-image.png`],
  ...
  '@graph': [
    {
      ...
      name: 'Zeneva',
      url: siteUrl,
      logo: `${siteUrl}/zeneva-og-image.png`,
      sameAs: [
      ...
      <head>
        ...
        {process.env.NODE_ENV === 'production' && (
          <Script id="tiktok-pixel" strategy="afterInteractive">
            {`
               !function (w, d, t) {
                 w.TiktokAnalyticsObject=t;var ttq=w[t]=w[t]||[];ttq.methods=["page","track","identify","instances","debug","on","off","once","ready","alias","group","detach","updateConfig"],ttq.setAndLog=function(t,e){return function(){t.push([e].concat(Array.prototype.slice.call(arguments,0)))}};for(var i=0;i<ttq.methods.length;i++)ttq[ttq.methods[i]]=ttq.setAndLog(ttq,ttq.methods[i]);ttq.instance=function(t){for(var e=ttq._i[t]||[],n=0;n<ttq.methods.length;n++)e[ttq.methods[n]]=e.setAndLog(e,ttq.methods[n]);return e},ttq.load=function(e,n){var i="https://analytics.tiktok.com/i18n/pixel/events.js";ttq._i=ttq._i||{},ttq._i[e]=[],ttq._i[e]._u=i,ttq._t=ttq._t||{},ttq._t[e]=+new Date,ttq._o=ttq._o||{},ttq._o[e]=n||{};var o=d.createElement("script");o.type="text/javascript",o.async=!0,o.src=i+"?sdkid="+e+"&lib="+t;var a=d.getElementsByTagName("script")[0];a.parentNode.insertBefore(o,a)};
