    ...
    return (
        <div className="absolute inset-0 pointer-events-none -z-10 overflow-hidden [mask-image:linear-gradient(to_bottom,black_55%,transparent_65%)]">
            <svg
                width="100%"
                height="100%"
                className="absolute inset-0 h-full w-full border-gray-200/30 dark:border-gray-800/30"
                style={{
                    ...
                    {Array.from({ length: rows * cols }).map((_, i) => {
                        ...
                        return (
                            <rect
                                ...
                                width={gridSize}
                                height={gridSize}
                                className="stroke-gray-200/10 dark:stroke-gray-800/10 transition-all duration-100 ease-in-out [&:not(:hover)]:duration-1000 fill-transparent hover:fill-gray-100/50 dark:hover:fill-gray-800/50 pointer-events-auto cursor-crosshair"
                            />
                        );
                    })}
                </svg>
