...
import { writeBatch, collection, doc, getDoc, updateDoc } from 'firebase/firestore';
...
const HEADER_MAPPINGS: { [key: string]: string[] } = {
  ...
  description: ['ShortDescription', 'Description', 'Details'],
};
    ...
    Papa.parse(fileToParse, {
      ...
      complete: (results) => {
        ...
        const data: ParsedProduct[] = results.data.map((row: any) => ({
          ...
          price: parseFloat(row[mappedHeaders.price!]) || 0,
    ...
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-3xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Upload a CSV file to bulk-add products to your inventory. Ensure your file has columns for at least 'Name' and 'Price'.
          </DialogDescription>
        </DialogHeader>
